...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const variantClasses = {
    ...
    purple: "bg-neo-purple text-white shadow-[8px_0_0_0_black] dark:shadow-[8px_0_0_0_white]",
    cyan: "bg-neo-cyan text-black shadow-[8px_0_0_0_black] dark:shadow-[8px_0_0_0_white]",
    green: "bg-neo-green text-black shadow-[8px_0_0_0_black] dark:shadow-[8px_0_0_0_white]",
    yellow: "bg-neo-yellow text-black shadow-[8px_0_0_0_black] dark:shadow-[8px_0_0_0_white]",
  };
