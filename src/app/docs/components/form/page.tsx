    ...
    <div className="space-y-12 pb-20">
      <Card variant={activeVariant === "default" ? "green" : activeVariant} className="p-8 md:p-12 transition-colors duration-500">
        ...
        <p className="text-xl md:text-2xl font-bold opacity-90 max-w-2xl text-black">
          High-contrast data entry systems with structured layouts and heavy tactical feedback.
        </p>
      </Card>
      ...
      <div className="grid gap-16">
        <section className="space-y-8">
          ...
          <Card variant={activeVariant === "default" ? "green" : activeVariant} className="p-16 md:p-32 flex justify-center items-center transition-colors duration-500 min-h-[700px]">
             {/* STATIC SIZE: Removed scale, used a robust max-width and large padding */}
             <div className="w-full max-w-2xl">
                <Form variant={activeVariant} title="Tactical Intake" className="p-16" />
             </div>
          </Card>
        </section>
        ...
        <section className="space-y-8">
          ...
          <div className="h-[300px]">
             <FlipCard code={`import { Form } from "@/ui/form/Form";

<Form variant="green" onSubmit={(data) => console.log(data)} />`}>
                <div className="flex flex-col items-center justify-center h-full space-y-4">
                   <div className="bg-neo-green px-6 py-3 neo-border shadow-neo">
                      <span className="font-black uppercase text-xl italic text-black">INTAKE MODULE</span>
                   </div>
                   <p className="font-bold opacity-70 uppercase tracking-widest text-xs">Flip for structure</p>
                </div>
             </FlipCard>
          </div>
        </section>
